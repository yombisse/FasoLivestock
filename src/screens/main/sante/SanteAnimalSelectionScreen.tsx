...
const SanteAnimalSelectionScreen = () => {
  ...
  const loadAnimals = async () => {
    try {
      ...
      // Use local-first pattern - only active animals can receive sanitary events
  ...
  const handleAnimalSelect = (animal: any) => {
    navigation.navigate('SanteCreate' as never, { animal } as never);
  };
...
export default SanteAnimalSelectionScreen;
